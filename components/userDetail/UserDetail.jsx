...
class UserDetail extends React.Component {
  constructor(props) {
    ...
    fetchModel(`http://localhost:5000/user/${this.props.match.params.userId}`).then(response=>{ this.setState({user : response.data}); this.props.changeView(`${this.state.user.first_name} ${this.state.user.last_name}`);
    })
  }
  componentDidUpdate = () => {
